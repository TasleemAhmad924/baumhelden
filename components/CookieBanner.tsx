          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:gap-6">
            ...
            <div className="flex-1">
              <p className="text-sm md:text-base text-gray-700 mb-2">
                ...
                IP-Adresse), um die Nutzung unserer Website zu analysieren und
                zu verbessern.
              </p>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg shadow-lg p-8 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <p className="text-gray-700 mb-6">
              Wir verwenden Cookies und ähnliche Technologien auf unserer
              Website und verarbeiten personenbezogene Daten von dir (z. B.
              IP-Adresse), um die Nutzung unserer Website zu analysieren und zu
              verbessern. Die Datenverarbeitung kann auch erst in Folge
              gesetzter Cookies stattfinden. Wir teilen diese Daten mit Dritten,
              die wir in den Privatsphäre-Einstellungen benennen.
            </p>
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600">
                      Google LLC, USA – Zur Analyse des Nutzerverhaltens auf
                      unserer Website
                    </p>
                  </div>
                  <div className="ml-4">
            ...
            <div className="mb-6">
              ...
              <p className="text-gray-700 mb-4">
                Wir nutzen den Google Consent Mode, um sicherzustellen, dass
                Google-Dienste nur mit deiner Zustimmung Daten verarbeiten.
              </p>
              <p className="text-gray-700 mb-4">
                Der Google Consent Mode ist ein Standard für die Einholung von
                Einwilligungen zur Verarbeitung personenbezogener Daten und zum
                Setzen von Cookies durch teilnehmende Partner. Es besteht die
                Möglichkeit Einwilligungen zur Datenverarbeitung für definierte
                Zwecke zu erteilen, sodass auf dieser Website eingesetzte
                Google-Services und die mit Google Tag integrierten Tags von
                Drittanbietern Daten nur im gewünschen Maße verarbeiten können.
              </p>
              <p className="text-gray-700 mb-4">
                Wenn du nicht einwilligst, erhältst du ein Service, der für dich
                weniger personalisiert ist. Die wichtigsten Leistungen bleiben
                jedoch dieselben und es gibt keine fehlenden Features, die nicht
                unbedingt deine Einwilligung erfordern.
              </p>
              <p className="text-gray-700 mb-4">
                Unabhängig davon besteht im Abschnitt &quot;Nicht
                standardisierte Datenverarbeitung&quot; die Möglichkeit, in den
                Einsatz von Services einzuwilligen oder das Recht auf
                Widerspruch gegen berechtigte Interessen auszuüben. Einzelheiten
                zur spezifischen Datenverarbeitung sind in dem benannten
                Abschnitt zu finden.
              </p>
              <p className="text-gray-700">
                Weitere Informationen zur Verarbeitung personenbezogener Daten
                durch Google und Partner findest du hier.
              </p>
            </div>
            ...
            <div className="mb-6">
              ...
              <p className="text-gray-700 mb-4">
                Die Datenverarbeitung kann mit deiner Einwilligung oder auf
                Basis eines berechtigten Interesses erfolgen, dem du in den
                Privatsphäre-Einstellungen widersprechen kannst. Die
            ...
            <div className="mb-6">
              ...
              <p className="text-gray-700 mb-4">
                Einige der von uns verwendeten Dienste übermitteln
                personenbezogene Daten in Drittländer außerhalb des Europäischen
                Wirtschaftsraums (EWR). Die Kommission der Europäischen Union
                hat für einige Drittländer ein Angemessenheitsbeschluss
                erlassen. In anderen Fällen erfolgt die Übermittlung auf
                Grundlage von Standardvertragsklauseln oder anderen geeigneten
                Garantien.
              </p>
            </div>
              ...
              {showAnalyticsDetails && (
                <div className="mt-4 p-4 bg-gray-50 rounded-lg">
                  <p className="text-sm text-gray-700">
                    Google Analytics ist ein Webanalysedienst von Google LLC,
                    1600 Amphitheatre Parkway, Mountain View, CA 94043, USA
                    (&quot;Google&quot;). Google Analytics verwendet sogenannte
                    &quot;Cookies&quot;, Textdateien, die auf Ihrem Computer
                    gespeichert werden und die eine Analyse der Benutzung der
                    Website durch Sie ermöglichen. Die durch das Cookie
                    ...
                    der IP-Anonymisierung auf dieser Website, wird Ihre
                    IP-Adresse von Google jedoch innerhalb von Mitgliedstaaten
            ...
            <div className="mb-6 p-4 bg-emerald-50 border border-emerald-200 rounded-lg">
              <p className="text-sm text-emerald-800">
                <strong>Du bist unter 16 Jahre alt?</strong> Dann kannst du
                nicht in optionale Services einwilligen. Bitte bitte deine
                Eltern oder Erziehungsberechtigten, diese Einwilligung mit dir
                zu treffen.
              </p>
            </div>

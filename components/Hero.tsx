...
export function Hero() {
  ...
  return (
    <header 
      id="hero"
      className="relative w-full h-[50vh] sm:h-[60vh] lg:h-[70vh] max-h-[820px] overflow-hidden pt-20 sm:pt-24"
      aria-label="Hero"
    >
      {/* Background Image */}
      ...
      {/* Hero Card */}
      <div className="relative z-10 h-full flex items-center justify-start -mt-20 sm:-mt-24">

export function DatenschutzContent() {
  return (
    <div className="prose prose-gray max-w-none">
      ...
      <h2 id="m716" className="text-xl font-semibold text-gray-900 mb-4">Präambel</h2>
      ...
      <h2 className="text-xl font-semibold text-gray-900 mb-4">Inhaltsübersicht</h2>
      <ul className="list-disc pl-6 mb-6 text-gray-700">
        <li><a href="#m716" className="text-emerald-600 hover:text-emerald-700 transition-colors">Präambel</a></li>
        <li><a href="#m3" className="text-emerald-600 hover:text-emerald-700 transition-colors">Verantwortlicher</a></li>
        <li><a href="#mOverview" className="text-emerald-600 hover:text-emerald-700 transition-colors">Übersicht der Verarbeitungen</a></li>
        <li><a href="#m2427" className="text-emerald-600 hover:text-emerald-700 transition-colors">Maßgebliche Rechtsgrundlagen</a></li>
        <li><a href="#m27" className="text-emerald-600 hover:text-emerald-700 transition-colors">Sicherheitsmaßnahmen</a></li>
        <li><a href="#m25" className="text-emerald-600 hover:text-emerald-700 transition-colors">Übermittlung von personenbezogenen Daten</a></li>
        <li><a href="#m24" className="text-emerald-600 hover:text-emerald-700 transition-colors">Internationale Datentransfers</a></li>
        <li><a href="#m12" className="text-emerald-600 hover:text-emerald-700 transition-colors">Allgemeine Informationen zur Datenspeicherung und Löschung</a></li>
        <li><a href="#m10" className="text-emerald-600 hover:text-emerald-700 transition-colors">Rechte der betroffenen Personen</a></li>
        <li><a href="#m13" className="text-emerald-600 hover:text-emerald-700 transition-colors">Geschäftsprozesse und -verfahren</a></li>
        <li><a href="#m225" className="text-emerald-600 hover:text-emerald-700 transition-colors">Bereitstellung des Onlineangebots und Webhosting</a></li>
        <li><a href="#m134" className="text-emerald-600 hover:text-emerald-700 transition-colors">Einsatz von Cookies</a></li>
        <li><a href="#m182" className="text-emerald-600 hover:text-emerald-700 transition-colors">Kontakt- und Anfrageverwaltung</a></li>
        <li><a href="#m391" className="text-emerald-600 hover:text-emerald-700 transition-colors">Kommunikation via Messenger</a></li>
        <li><a href="#m263" className="text-emerald-600 hover:text-emerald-700 transition-colors">Webanalyse, Monitoring und Optimierung</a></li>
        <li><a href="#m136" className="text-emerald-600 hover:text-emerald-700 transition-colors">Präsenzen in sozialen Netzwerken (Social Media)</a></li>
        <li><a href="#m328" className="text-emerald-600 hover:text-emerald-700 transition-colors">Plug-ins und eingebettete Funktionen sowie Inhalte</a></li>
      </ul>

      <h2 id="m3" className="text-xl font-semibold text-gray-900 mb-4">Verantwortlicher</h2>
      <p className="text-gray-700 mb-2 leading-relaxed">
        Christian Theunert<br />
        Trappenstraße 12<br />
        23558 Lübeck
      </p>
      <p className="text-gray-700 mb-2 leading-relaxed">
        E-Mail-Adresse: <a href="mailto:info@baumhelden-luebeck.de" className="text-emerald-600 hover:text-emerald-700 transition-colors">info@baumhelden-luebeck.de</a>
      </p>
      <p className="text-gray-700 mb-6 leading-relaxed">
        Telefon: <a href="tel:+4916093490444" className="text-emerald-600 hover:text-emerald-700 transition-colors">+49 160 93490444</a>
      </p>

      <h2 id="mOverview" className="text-xl font-semibold text-gray-900 mb-4">Übersicht der Verarbeitungen</h2>
      <p className="text-gray-700 mb-4 leading-relaxed">
        Die nachfolgende Übersicht fasst die Arten der verarbeiteten Daten und die Zwecke ihrer Verarbeitung zusammen und verweist auf die betroffenen Personen.
      </p>

      <h3 className="text-lg font-semibold text-gray-900 mb-3">Arten der verarbeiteten Daten</h3>
      <ul className="list-disc pl-6 mb-6 text-gray-700">
        <li>Bestandsdaten.</li>
        <li>Zahlungsdaten.</li>
        <li>Standortdaten.</li>
      ...
      <h3 className="text-lg font-semibold text-gray-900 mb-3">Kategorien betroffener Personen</h3>
      <ul className="list-disc pl-6 mb-6 text-gray-700">
      ...
      <h3 className="text-lg font-semibold text-gray-900 mb-3">Zwecke der Verarbeitung</h3>
      <ul className="list-disc pl-6 mb-6 text-gray-700">
      ...
      <h2 id="m2427" className="text-xl font-semibold text-gray-900 mb-4">Maßgebliche Rechtsgrundlagen</h2>
      <p className="text-gray-700 mb-4 leading-relaxed">
      ...
      <h2 id="m27" className="text-xl font-semibold text-gray-900 mb-4">Sicherheitsmaßnahmen</h2>
      <p className="text-gray-700 mb-4 leading-relaxed">
      ...
      <h2 id="m25" className="text-xl font-semibold text-gray-900 mb-4">Übermittlung von personenbezogenen Daten</h2>
      <p className="text-gray-700 mb-4 leading-relaxed">
      ...
      <h2 id="m24" className="text-xl font-semibold text-gray-900 mb-4">Internationale Datentransfers</h2>
      <p className="text-gray-700 mb-4 leading-relaxed">
      ...
      <h2 id="m10" className="text-xl font-semibold text-gray-900 mb-4">Rechte der betroffenen Personen</h2>
      <p className="text-gray-700 mb-4 leading-relaxed">
      ...
      <h2 id="m13" className="text-xl font-semibold text-gray-900 mb-4">Geschäftsprozesse und -verfahren</h2>
      <p className="text-gray-700 mb-4 leading-relaxed">
      ...
      <h2 id="m225" className="text-xl font-semibold text-gray-900 mb-4">Bereitstellung des Onlineangebots und Webhosting</h2>
      <p className="text-gray-700 mb-4 leading-relaxed">
        Wir verarbeiten die Daten der Nutzer, um ihnen unsere Online-Dienste zur Verfügung stellen zu können. Zu diesem Zweck verarbeiten wir die IP-Adresse des Nutzers, die notwendig ist, um die Inhalte und Funktionen unserer Online-Dienste an den Browser oder das Endgerät der Nutzer zu übermitteln.
      </p>

      <h2 id="m134" className="text-xl font-semibold text-gray-900 mb-4">Einsatz von Cookies</h2>
      <p className="text-gray-700 mb-4 leading-relaxed">
      ...
      <h2 id="m182" className="text-xl font-semibold text-gray-900 mb-4">Kontakt- und Anfrageverwaltung</h2>
      <p className="text-gray-700 mb-4 leading-relaxed">
        Bei der Kontaktaufnahme mit uns (z. B. per Post, Kontaktformular, E-Mail, Telefon oder via soziale Medien) sowie im Rahmen bestehender Nutzer- und Geschäftsbeziehungen werden die Angaben der anfragenden Personen verarbeitet, soweit dies zur Beantwortung der Kontaktanfragen und etwaiger angefragter Maßnahmen erforderlich ist.
      </p>

      <h2 id="m391" className="text-xl font-semibold text-gray-900 mb-4">Kommunikation via Messenger</h2>
      <p className="text-gray-700 mb-4 leading-relaxed">
      ...
      <h2 id="m263" className="text-xl font-semibold text-gray-900 mb-4">Webanalyse, Monitoring und Optimierung</h2>
      <p className="text-gray-700 mb-4 leading-relaxed">
      ...
      <h2 id="m136" className="text-xl font-semibold text-gray-900 mb-4">Präsenzen in sozialen Netzwerken (Social Media)</h2>
      <p className="text-gray-700 mb-4 leading-relaxed">
        Wir unterhalten Onlinepräsenzen innerhalb sozialer Netzwerke und verarbeiten in diesem Rahmen Nutzerdaten, um mit den dort aktiven Nutzern zu kommunizieren oder Informationen über uns anzubieten.
      </p>

      <h2 id="m328" className="text-xl font-semibold text-gray-900 mb-4">Plug-ins und eingebettete Funktionen sowie Inhalte</h2>
      <p className="text-gray-700 mb-4 leading-relaxed">
      ...
      <p className="text-sm text-gray-500 mt-8 pt-4 border-t border-gray-200">
        <a href="https://datenschutz-generator.de/" target="_blank" rel="noopener noreferrer" className="text-emerald-600 hover:text-emerald-700 transition-colors">

...
export function DatenschutzContent() {
  return (
    <div className="prose prose-gray max-w-none">
      ...
      <h2 id="m716" className="text-xl font-semibold text-gray-900 mb-4">
        Präambel
      </h2>
      ...
      <h2 id="m3" className="text-xl font-semibold text-gray-900 mb-4">
        Verantwortlicher
      </h2>
      ...
      <h2 id="mOverview" className="text-xl font-semibold text-gray-900 mb-4">
        Übersicht der Verarbeitungen
      </h2>
      <p className="text-gray-700 mb-4 leading-relaxed">
      ...
      <h2 id="m2427" className="text-xl font-semibold text-gray-900 mb-4">
        Maßgebliche Rechtsgrundlagen
      </h2>
      <p className="text-gray-700 mb-4 leading-relaxed">
      ...
      <h2 id="m27" className="text-xl font-semibold text-gray-900 mb-4">
        Sicherheitsmaßnahmen
      </h2>
      <p className="text-gray-700 mb-4 leading-relaxed">
      ...
      <h2 id="m25" className="text-xl font-semibold text-gray-900 mb-4">
        Übermittlung von personenbezogenen Daten
      </h2>
      <p className="text-gray-700 mb-4 leading-relaxed">
      ...
      <h2 id="m24" className="text-xl font-semibold text-gray-900 mb-4">
        Internationale Datentransfers
      </h2>
      <p className="text-gray-700 mb-4 leading-relaxed">
      ...
      <h2 id="m12" className="text-xl font-semibold text-gray-900 mb-4">
        Allgemeine Informationen zur Datenspeicherung und Löschung
      </h2>
      <p className="text-gray-700 mb-4 leading-relaxed">
      ...
      <h2 id="m10" className="text-xl font-semibold text-gray-900 mb-4">
        Rechte der betroffenen Personen
      </h2>
      <p className="text-gray-700 mb-4 leading-relaxed">
      ...
      <h2 id="m13" className="text-xl font-semibold text-gray-900 mb-4">
        Geschäftsprozesse und -verfahren
      </h2>
      <p className="text-gray-700 mb-4 leading-relaxed">
      ...
      <h2 id="m225" className="text-xl font-semibold text-gray-900 mb-4">
        Bereitstellung des Onlineangebots und Webhosting
      </h2>
      <p className="text-gray-700 mb-4 leading-relaxed">
      ...
      <h2 id="m134" className="text-xl font-semibold text-gray-900 mb-4">
        Einsatz von Cookies
      </h2>
      <p className="text-gray-700 mb-4 leading-relaxed">
      ...
      <h2 id="m182" className="text-xl font-semibold text-gray-900 mb-4">
        Kontakt- und Anfrageverwaltung
      </h2>
      <p className="text-gray-700 mb-4 leading-relaxed">
      ...
      <h2 id="m391" className="text-xl font-semibold text-gray-900 mb-4">
        Kommunikation via Messenger
      </h2>
      <p className="text-gray-700 mb-4 leading-relaxed">
      ...
      <h2 id="m263" className="text-xl font-semibold text-gray-900 mb-4">
        Webanalyse, Monitoring und Optimierung
      </h2>
      <p className="text-gray-700 mb-4 leading-relaxed">
      ...
      <h2 id="m136" className="text-xl font-semibold text-gray-900 mb-4">
        Präsenzen in sozialen Netzwerken (Social Media)
      </h2>
      <p className="text-gray-700 mb-4 leading-relaxed">
      ...
      <h2 id="m328" className="text-xl font-semibold text-gray-900 mb-4">
        Plug-ins und eingebettete Funktionen sowie Inhalte
      </h2>
      <p className="text-gray-700 mb-4 leading-relaxed">

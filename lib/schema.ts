export const baumheldenSchema = {
  ...
  description:
    'Professionelle Baumpflege in Lübeck. Hilfe bei Sturmschäden, Baumfällung, Entsorgung und Wurzelentfernung. Nachhaltiger und zuverlässiger Service.',
    ...
    itemListElement: [
      {
        ...
        itemOffered: {
          ...
          description:
            'Notfall-Baumfällung und Aufräumarbeiten nach Sturmschäden',
        },
      },
      {
        '@type': 'Offer',
